document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('experience').value = localStorage.getItem('experience') || 'beginner';
  document.getElementById('goals').value = localStorage.getItem('goals') || 'strength';
  document.getElementById('time').value = localStorage.getItem('time') || '';
  document.getElementById('workouts').value = localStorage.getItem('workouts') || '';
  document.getElementById('time-per-workout').value = localStorage.getItem('time-per-workout') || '';
  ...
  form.addEventListener('submit', (e) => {
      ...
      const timePerWorkout = document.getElementById('time-per-workout').value;
      ...
      localStorage.setItem('time-per-workout', timePerWorkout);
      localStorage.setItem('availability', availability);

      alert("Your workout goals have been saved locally!");

      if(time == 3)
        alert("WORKS")
    
    total(experience, goals, time)
  });
});
